                    ...
                    <Row>
                        ...
                        <Col md={4} style={{ padding: '20px', width: '20%' }} className="3 d-flex flex-column">
                            <div className='book-image'>
                                <img src={book.image} alt='book' style={{ borderRadius: '10px', width: '90%' }} />
                            </div>
                        </Col>
                        ...
                        <Col style={{ padding: '30px', paddingLeft: '70px' }} md={6} className="9 d-flex flex-column">
                            <div className='book-details'>
                                <a href="#none" style={{ marginBottom: '30px', textDecoration: 'none' }} className="text-decoration-none text-primary bold">
                                    <h5>{book.name}</h5>
                                </a>
                                <b style={{ marginTop: '30px' }}>By- {book.author}</b>
                                <h5 style={{ marginTop: '30px' }}>Price : {book.price}$</h5>
                                <a href="#no" style={{ marginTop: '30px' }} className="btn btn-outline-danger">
