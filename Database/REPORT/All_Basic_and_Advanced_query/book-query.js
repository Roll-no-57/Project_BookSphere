...
async function getAllBooks() {
    ...
    const sql = `
    SELECT 
        book.*,(SELECT name FROM author WHERE id = book.author_id) AS author_name
        FROM book
...
async function getBooksByCategory(categoryName) {
    ...
    SELECT 
    book.*,
    (SELECT name FROM author WHERE id = book.author_id) AS author_name
FROM 
    book
WHERE 
    genre = :categoryName
...
async function getBooksByPublisherID(ID) {
    ...
    BOOK.*, 
    (SELECT name FROM author WHERE id = book.author_id) AS author_name,
    (SELECT description FROM author WHERE id = book.author_id) AS author_description,
    (SELECT image FROM author WHERE id = book.author_id) AS author_image,
    publisher.name AS publisher_name
FROM 
    book
JOIN 
